...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/programs/stepup-scholars',
    name: 'stepup',
    component: () => import('../views/StepUp.vue'),
    meta: { title: 'StepUp Scholars' },
  },
  {
    path: '/programs/dynamerge',
    name: 'dynamerge',
    component: () => import('../views/Dynamerge.vue'),
    meta: { title: 'Dynamerge' },
  },
  {
    path: '/get-involved',
    name: 'get-involved',
  ...
  {
    path: '/apply/:program/:step?',
    name: 'apply',
    component: () => import('../views/apply/Apply.vue'),
    meta: { title: 'Apply — STAIJA', requiresAuth: true },
  },
  {
    path: '/refs/:token',
    name: 'reference-upload',
    component: () => import('../views/refs/ReferenceUpload.vue'),
    meta: { title: 'Submit a reference — STAIJA' },
  },
  ...
  // `?redirect=/invite/<token>` when no session exists.
  {
    ...
    meta: { title: 'Accept your mentor invitation — STAIJA' },
  },
  ...
  // dashboards / cohort surfaces / admin user lists.
  {
    path: '/mentors',
    name: 'mentors-index',
    component: () => import('../views/MentorsIndex.vue'),
    meta: { title: 'Mentors — STAIJA', requiresAuth: true },
  },
  {
    path: '/mentors/:uid',
    name: 'mentor-profile',
    component: () => import('../views/MentorProfile.vue'),
    meta: { title: 'Mentor — STAIJA', requiresAuth: true },
  },
  ...
  // graceful exit and as a permanent destination linked from home.
  {
    path: '/stay-connected',
    name: 'stay-connected',
    component: () => import('../views/StayConnected.vue'),
    meta: { title: 'Stay connected — STAIJA' },
  },
  {
    path: '/about',
    name: 'about',
  ...
  },
  {
    ...
    component: () => import('../views/applicant/ApplicantApplications.vue'),
    meta: {
      title: 'My Applications — STAIJA',
      requiresAuth: true,
      permissions: ['view_own_applications'],
  ...
  { path: '/applicant/applications/new', redirect: '/programs' },
  {
    ...
    component: () => import('../views/apply/Status.vue'),
    meta: {
      title: 'Application Status — STAIJA',
      requiresAuth: true,
      permissions: ['view_own_applications'],
    },
  },
  {
    ...
    component: () => import('../views/applicant/EditApplication.vue'),
    meta: {
      title: 'Edit Application — STAIJA',
      requiresAuth: true,
      permissions: ['edit_own_applications'],
    },
  },
  ...
  // prefix the visitor is already on.
  {
    ...
    meta: { title: 'Admin Panel — STAIJA', requiresAuth: true, permissions: ['view_all_users'] },
  },
  {
    ...
    meta: {
      title: 'Applications Management — STAIJA',
      requiresAuth: true,
  ...
  // working without a redirect round-trip.
  {
    ...
    component: () => import('../views/admin/ReviewApplication.vue'),
    meta: {
      title: 'Review Application — STAIJA',
      requiresAuth: true,
  ...
  },
  {
    path: '/admin/programs',
    name: 'admin-programs',
    alias: '/staff/programs',
    component: () => import('../views/admin/ProgramManagement.vue'),
    meta: {
      title: 'Program Management — STAIJA',
      requiresAuth: true,
      permissions: ['manage_program_settings'],
    },
  },
  {
    path: '/admin/users',
    ...
    meta: { title: 'User Management — STAIJA', requiresAuth: true, permissions: ['manage_users'] },
  },
  {
    path: '/admin/cohorts',
    name: 'admin-cohorts',
    ...
    meta: { title: 'Cohorts — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  {
    path: '/admin/enroll',
    name: 'admin-enroll',
    alias: '/staff/enroll',
    component: () => import('../views/admin/EnrollStudent.vue'),
    meta: { title: 'Enroll student — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  ...
  // (matches the firestore.rules read on referralStats).
  {
    ...
    alias: '/staff/referrals',
    component: () => import('../views/admin/Referrals.vue'),
    meta: { title: 'Referrals — STAIJA', requiresAuth: true, permissions: ['view_all_users'] },
  },
  ...
  {
    path: '/admin/avatar-preview',
    name: 'admin-avatar-preview',
    alias: '/staff/avatar-preview',
    component: () => import('../views/admin/AvatarPreview.vue'),
    meta: { title: 'Avatar preview — STAIJA', requiresAuth: true },
  },
  ...
  // Both staff and admin can manage course content via manage_cohorts permission.
  {
    ...
    name: 'admin-content',
    alias: '/staff/content',
    component: () => import('../views/admin/content/ContentHome.vue'),
    meta: { title: 'Course content — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  {
    path: '/admin/content/outline',
    name: 'admin-content-outline',
    alias: '/staff/content/outline',
    component: () => import('../views/admin/content/CourseOutline.vue'),
    meta: {
      title: 'AI course outliner — STAIJA',
      requiresAuth: true,
  ...
  { path: '/staff/content/courses', redirect: '/staff/content' },
  {
    ...
    name: 'admin-content-course-edit',
    alias: '/staff/content/courses/:id',
    component: () => import('../views/admin/content/CourseEdit.vue'),
    meta: { title: 'Edit course — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  { path: '/admin/content/modules', redirect: '/admin/content' },
  { path: '/staff/content/modules', redirect: '/staff/content' },
  {
    path: '/admin/content/modules/:id',
    name: 'admin-content-module-edit',
    alias: '/staff/content/modules/:id',
    component: () => import('../views/admin/content/ModuleEdit.vue'),
    meta: { title: 'Edit module — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  { path: '/admin/content/lessons', redirect: '/admin/content' },
  { path: '/staff/content/lessons', redirect: '/staff/content' },
  {
    path: '/admin/content/lessons/:id',
    name: 'admin-content-lesson-edit',
    alias: '/staff/content/lessons/:id',
    component: () => import('../views/admin/content/LessonEdit.vue'),
    meta: { title: 'Edit lesson — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  { path: '/admin/content/assignments', redirect: '/admin/content' },
  { path: '/staff/content/assignments', redirect: '/staff/content' },
  {
    path: '/admin/content/assignments/:id',
    name: 'admin-content-assignment-edit',
    alias: '/staff/content/assignments/:id',
    component: () => import('../views/admin/content/AssignmentEdit.vue'),
    meta: {
      title: 'Edit assignment — STAIJA',
      requiresAuth: true,
      permissions: ['manage_cohorts'],
    },
  },
  ...
  {
    path: '/admin/content/quizzes/:id',
    name: 'admin-content-quiz-edit',
    alias: '/staff/content/quizzes/:id',
    component: () => import('../views/admin/content/QuizEdit.vue'),
    meta: { title: 'Edit quiz — STAIJA', requiresAuth: true, permissions: ['manage_cohorts'] },
  },
  ...
  // LMS routes — student-facing
  {
    path: '/learn',
    name: 'learn-home',
    component: () => import('../views/learn/CourseHome.vue'),
    meta: {
      title: 'My course — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
    },
  },
  {
  ...
  },
  {
    ...
    name: 'learn-module',
    component: () => import('../views/learn/ModuleView.vue'),
    meta: {
      title: 'Module — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
  ...
  {
    path: '/learn/assignment/:slug',
    name: 'learn-assignment',
    component: () => import('../views/learn/AssignmentView.vue'),
    meta: {
      title: 'Assignment — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
    },
  },
  {
    path: '/learn/submissions/:id',
    name: 'learn-submission',
    component: () => import('../views/learn/SubmissionDetail.vue'),
    meta: {
      title: 'Submission — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
    },
  },
  {
    path: '/learn/sessions',
    name: 'learn-sessions',
    component: () => import('../views/learn/SessionsList.vue'),
    meta: {
      title: 'Sessions — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
    },
  },
  {
    path: '/learn/sessions/:id',
    name: 'learn-session',
    component: () => import('../views/learn/SessionDetail.vue'),
    meta: {
      title: 'Session — STAIJA',
      requiresAuth: true,
      permissions: ['participate_in_programs'],
    },
  },
  ...
  {
    path: '/learn/mentor/students/:studentId',
    name: 'learn-mentor-student',
    component: () => import('../views/learn/mentor/StudentDetail.vue'),
    meta: {
      title: 'Student — STAIJA',
      requiresAuth: true,
      permissions: ['view_assigned_students'],
    },
  },
  {
    path: '/learn/mentor/submissions/:id',
    name: 'learn-mentor-submission',
    component: () => import('../views/learn/mentor/SubmissionReview.vue'),
    meta: {
      title: 'Review submission — STAIJA',
      requiresAuth: true,
      permissions: ['grade_submissions'],
    },
  },
  {
    path: '/learn/mentor/schedule',
    name: 'learn-mentor-schedule',
    component: () => import('../views/learn/mentor/ScheduleSession.vue'),
    meta: {
      title: 'Schedule session — STAIJA',
      requiresAuth: true,
  ...
  // Account settings (all authenticated users)
  {
    ...
    meta: { title: 'Account Settings — STAIJA', requiresAuth: true },
  },
  ...
  // Email Link Authentication
  {
    ...
    component: () => import('../views/auth/EmailLinkCallback.vue'),
    meta: { title: 'Sign In — STAIJA' },
  },
  ...
  // Mentor portal routes
  {
    ...
    component: () => import('../views/mentor/MentorDashboard.vue'),
    meta: {
      title: 'Mentor portal — STAIJA',
      requiresAuth: true,
      permissions: ['view_assigned_students'],
    },
  },
  {
    path: '/mentor/feedback/:studentId',
    name: 'mentor-feedback',
    component: () => import('../views/mentor/MentorFeedback.vue'),
    meta: {
      title: 'Leave feedback — STAIJA',
      requiresAuth: true,
      permissions: ['submit_mentor_feedback'],
    },
  },
  ...
  // Alumni portal routes
  {
    ...
    meta: { title: 'Alumni — STAIJA', requiresAuth: true, permissions: ['access_alumni_portal'] },
  },
  {
    path: '/alumni/profile',
    name: 'alumni-profile',
    component: () => import('../views/alumni/AlumniProfile.vue'),
    meta: {
      title: 'My Alumni Profile — STAIJA',
      requiresAuth: true,
      permissions: ['access_alumni_portal'],
    },
  },
  {
    path: '/alumni/directory',
    name: 'alumni-directory',
    component: () => import('../views/alumni/AlumniDirectory.vue'),
    meta: {
      title: 'Alumni Directory — STAIJA',
      requiresAuth: true,
      permissions: ['network_with_alumni'],
    },
  },
  {
    path: '/alumni/stories',
    name: 'alumni-stories',
    component: () => import('../views/alumni/AlumniStories.vue'),
    meta: {
      title: 'Alumni Stories — STAIJA',
      requiresAuth: true,
      permissions: ['share_alumni_stories'],
    },
  },
